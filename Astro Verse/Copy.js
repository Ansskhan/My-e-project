...
footer.innerHTML = `
        ...
        <div class="foot-items d-flex justify-content-center">
            <div class="row m-0 p-0 " style="width: 70vw;">
                ...
                <div class="col-md-3 col-sm-6">
                    <a href="./index.html#developments">Latest Developments</a>
                </div>
                <div class="col-md-3 col-sm-6">
                    <a href="./constellation.html">Constellation</a>
                </div>
                <div class="col-md-3 col-sm-6">
                    <a href="./observation.html#observe">Observation</a>
                </div>
                <div class="col-md-3 col-sm-6">
                    <a href="./bigbang.html">Big Bang</a>
                </div>
                <div class="col-md-3 col-sm-6">
                    <a href="https://drive.google.com/file/d/1GyOIXTi9UdU64i7n9CpKCdq54Q7RM1hj/view?usp=sharing">About Me</a>
                </div>
            </div>
        </div>
        <hr>
